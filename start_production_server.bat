@echo off
title Flask Quiz Production Server
echo.
echo ===============================================
echo       FLASK QUIZ PRODUCTION SERVER
echo ===============================================
echo.
...
echo Advanced Admin:  http://%CLEAN_IP%:5000/admin
echo.
echo ===============================================
echo Production server optimized for 60+ students
