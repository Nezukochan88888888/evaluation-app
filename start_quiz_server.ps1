# PowerShell Script to Start Flask Quiz Server
param(
    [switch]$NoAutoOpen
)

# Set console title and colors
$Host.UI.RawUI.WindowTitle = "Flask Quiz Server"
Write-Host ""
Write-Host "===============================================" -ForegroundColor Cyan
Write-Host "          FLASK QUIZ APP SERVER" -ForegroundColor Yellow
Write-Host "===============================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "[INFO] Installing/checking required packages..." -ForegroundColor Blue
try {
    py -m pip install flask flask-sqlalchemy flask-login flask-admin flask-wtf werkzeug wtforms --quiet --upgrade
    Write-Host "[SUCCESS] Required packages ready!" -ForegroundColor Green
} catch {
